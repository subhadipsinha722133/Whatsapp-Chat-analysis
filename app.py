...
def create_wordcloud(selected_user, df):
    # Use default stop words if file not found
    try:
...
def main():
    ...
    st.sidebar.write("Made By Subhadip 😎")
    ...
    if uploaded_file is not None:
        ...
        if st.sidebar.button("Show Analysis"):
            ...
            # Check if there's data for the selected user
            if selected_user != 'Overall':
            ...
            # daily timeline - FIXED: renamed variable to avoid conflict
            ...
            with col2:
                ...
                if not busy_month.empty:
                    ...
                    st.write("No monthly activity data available")
            ...
            try:
                ...
                st.write("Could not generate wordcloud")
            ...
            if not most_common_df.empty:
                ...
                st.write("No common words data available")
